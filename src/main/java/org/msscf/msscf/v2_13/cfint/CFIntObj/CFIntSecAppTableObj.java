	...
	implements ICFIntSecAppTableObj
{
	...
	{
		final String S_ProcName = "CFIntSecAppTableObj.reallyDeepDisposeSecApp() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecSecAppByClusterIdxKey keyClusterIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecApp().newClusterIdxKey();
		keyClusterIdx.setRequiredClusterId( existing.getRequiredClusterId() );

		CFSecSecAppByUJEEMountIdxKey keyUJEEMountIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecApp().newUJEEMountIdxKey();
