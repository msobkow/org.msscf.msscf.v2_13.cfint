	...
	implements ICFIntISOTZoneTableObj
{
	...
	public void reallyDeepDisposeISOTZone( ICFSecISOTZoneObj obj )
	{
		...
		members.remove( pkey );
		CFSecISOTZoneByOffsetIdxKey keyOffsetIdx = ((ICFIntSchema)schema.getBackingStore()).getFactoryISOTZone().newOffsetIdxKey();
		...
		CFSecISOTZoneByUTZNameIdxKey keyUTZNameIdx = ((ICFIntSchema)schema.getBackingStore()).getFactoryISOTZone().newUTZNameIdxKey();
		keyUTZNameIdx.setRequiredTZName( existing.getRequiredTZName() );

		CFSecISOTZoneByIso8601IdxKey keyIso8601Idx = ((ICFIntSchema)schema.getBackingStore()).getFactoryISOTZone().newIso8601IdxKey();
