	...
	implements ICFIntSecGroupFormTableObj
{
	...
	{
		final String S_ProcName = "CFIntSecGroupFormTableObj.reallyDeepDisposeSecGroupForm() ";
		String classCode;
		if( obj == null ) {
			return;
		}
		...
		members.remove( pkey );
		CFSecSecGroupFormByClusterIdxKey keyClusterIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newClusterIdxKey();
		keyClusterIdx.setRequiredClusterId( existing.getRequiredClusterId() );

		CFSecSecGroupFormByGroupIdxKey keyGroupIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newGroupIdxKey();
		...
		CFSecSecGroupFormByAppIdxKey keyAppIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newAppIdxKey();
		keyAppIdx.setRequiredClusterId( existing.getRequiredClusterId() );
		keyAppIdx.setRequiredSecAppId( existing.getRequiredSecAppId() );

		CFSecSecGroupFormByFormIdxKey keyFormIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newFormIdxKey();
		...
		CFSecSecGroupFormByUFormIdxKey keyUFormIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newUFormIdxKey();
