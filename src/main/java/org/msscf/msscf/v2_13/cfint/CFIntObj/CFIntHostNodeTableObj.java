	...
	implements ICFIntHostNodeTableObj
{
	...
	public void reallyDeepDisposeHostNode( ICFSecHostNodeObj obj )
	{
		...
		members.remove( pkey );
		CFSecHostNodeByClusterIdxKey keyClusterIdx = ((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newClusterIdxKey();
		keyClusterIdx.setRequiredClusterId( existing.getRequiredClusterId() );

		CFSecHostNodeByUDescrIdxKey keyUDescrIdx = ((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newUDescrIdxKey();
		keyUDescrIdx.setRequiredClusterId( existing.getRequiredClusterId() );
		keyUDescrIdx.setRequiredDescription( existing.getRequiredDescription() );

		CFSecHostNodeByHostNameIdxKey keyHostNameIdx = ((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newHostNameIdxKey();
