	...
	implements ICFIntClusterTableObj
{
	...
	public void reallyDeepDisposeCluster( ICFSecClusterObj obj )
	{
		...
		members.remove( pkey );
		CFSecClusterByUDomNameIdxKey keyUDomNameIdx = ((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newUDomNameIdxKey();
		keyUDomNameIdx.setRequiredFullDomName( existing.getRequiredFullDomName() );

		CFSecClusterByUDescrIdxKey keyUDescrIdx = ((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newUDescrIdxKey();
