	...
	implements ICFIntSecSessionTableObj
{
	...
	public void reallyDeepDisposeSecSession( ICFSecSecSessionObj obj )
	{
		...
		members.remove( pkey );
		CFSecSecSessionBySecUserIdxKey keySecUserIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newSecUserIdxKey();
		keySecUserIdx.setRequiredSecUserId( existing.getRequiredSecUserId() );

		CFSecSecSessionBySecDevIdxKey keySecDevIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newSecDevIdxKey();
		...
		CFSecSecSessionByStartIdxKey keyStartIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newStartIdxKey();
		keyStartIdx.setRequiredSecUserId( existing.getRequiredSecUserId() );
		keyStartIdx.setRequiredStart( existing.getRequiredStart() );

		CFSecSecSessionByFinishIdxKey keyFinishIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newFinishIdxKey();
		keyFinishIdx.setRequiredSecUserId( existing.getRequiredSecUserId() );
		keyFinishIdx.setOptionalFinish( existing.getOptionalFinish() );

		CFSecSecSessionBySecProxyIdxKey keySecProxyIdx = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newSecProxyIdxKey();
